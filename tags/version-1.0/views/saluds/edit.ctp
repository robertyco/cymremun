...
<?php echo $form->create('Salud');?>
	<fieldset>
 		<legend><?php __('Edit Salud');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('Salud.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Salud.id'))); ?></li>
